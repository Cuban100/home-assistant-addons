## 1.0.10
 ...
 - Update hydra2 to 9.0.5 (linuxserver/nzbhydra2:v9.0.5-ls108)

## 1.0.9

 - Update hydra2 to 9.0.4 (linuxserver/nzbhydra2:v9.0.4-ls107)

## 1.0.8

 - Update hydra2 to 9.0.4 (linuxserver/nzbhydra2:v9.0.4-ls106)

## 1.0.7

 - Update hydra2 to 9.0.3 (linuxserver/nzbhydra2:v9.0.3-ls106)

## 1.0.6

 - Update hydra2 to 9.0.2 (linuxserver/nzbhydra2:v9.0.2-ls105)

## 1.0.5

 - Update hydra2 to 9.0.1 (linuxserver/nzbhydra2:v9.0.1-ls105)
...
## 1.0.2
 ...
 - Update hydra2 to 8.9.0 (linuxserver/nzbhydra2:v8.9.0-ls102)
...
## 1.0.0
 ...
 - Update hydra2 to 8.9.0 (linuxserver/nzbhydra2:v8.9.0-ls100)
 - Drop armhf (no longer published upstream); aarch64/amd64 only
 - Add `media:rw` to folder mappings so hydra2 can see the `/media` folder
 - Bump bashio 0.7.1 -> 0.18.1
 - Build image now floats on linuxserver/nzbhydra2's `latest` tag per arch, and a
   scheduled GitHub Action bumps this add-on's version whenever upstream releases a
   new nzbhydra2 build, so Home Assistant shows "Update available" automatically
